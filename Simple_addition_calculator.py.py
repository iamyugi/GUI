...
def button_like():
    second = Tk()
    second.title("Like Window")
    mylabel=Label(second,text="Credits:Yokesh ! Thank You for Like ")
    mylabel.pack()
...
button_like= Button(root,text="Like",padx=30,pady=20,command=button_like)
...
button_like.grid(row=5,column=2)
